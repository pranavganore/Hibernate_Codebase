...
public class DeleteStudentDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//	Delete the Student	-- make sure you are deleting an existing student
			System.out.println("\nDeleting the Student : " + tempStudent);
			
			session.delete(tempStudent); 	//	Observe after deleting student, associated many courses are intact in database.
